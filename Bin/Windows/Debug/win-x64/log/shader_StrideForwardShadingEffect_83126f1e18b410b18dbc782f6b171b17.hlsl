...
//
#line 1036 "E:\User\Documentos\Stride Projects\ProyectileSampler\Bin\Windows\Debug\win-x64\log\shader_StrideForwardShadingEffect_83126f1e18b410b18dbc782f6b171b17.hlsl"
...
@G    Pixel => 0a0ca2fa49e863a4782ddfd08b38215b
//
// Generated by Microsoft (R) HLSL Shader Compiler 10.1
//
//
...
//
#line 1098 "E:\User\Documentos\Stride Projects\ProyectileSampler\Bin\Windows\Debug\win-x64\log\shader_StrideForwardShadingEffect_83126f1e18b410b18dbc782f6b171b17.hlsl"
...
#line 449
  sample_c_lz r9.x, r12.xyxx, t0.xxxx, s0, r7.w  // r9.x <- <SampleTextureAndCompare_id61 return value>
  sample_c_lz r9.y, r12.zwzz, t0.xxxx, s0, r7.w  // r9.y <- <SampleTextureAndCompare_id61 return value>
...
#line 449
  sample_c_lz r9.x, r14.xyxx, t0.xxxx, s0, r7.w  // r9.x <- <SampleTextureAndCompare_id61 return value>

#line 508
  mad r7.y, r8.z, r9.x, r7.y

#line 449
  sample_c_lz r8.z, r13.xyxx, t0.xxxx, s0, r7.w  // r8.z <- <SampleTextureAndCompare_id61 return value>

#line 508
  mad r7.y, r9.w, r8.z, r7.y

#line 449
  sample_c_lz r8.z, r13.zwzz, t0.xxxx, s0, r7.w

#line 508
  mad r7.y, r8.z, l(49.000000), r7.y

#line 449
  sample_c_lz r8.z, r14.zwzz, t0.xxxx, s0, r7.w

#line 508
  mad r7.y, r11.z, r8.z, r7.y

#line 449
  sample_c_lz r8.z, r10.xyxx, t0.xxxx, s0, r7.w

#line 508
  mad r7.y, r8.w, r8.z, r7.y

#line 449
  sample_c_lz r8.z, r10.zwzz, t0.xxxx, s0, r7.w

#line 508
  mad r7.y, r11.w, r8.z, r7.y

#line 449
  sample_c_lz r7.w, r8.xyxx, t0.xxxx, s0, r7.w  // r7.w <- <SampleTextureAndCompare_id61 return value>
...
#line 449
      sample_c_lz r5.w, r12.xyxx, t0.xxxx, s0, r2.z  // r5.w <- <SampleTextureAndCompare_id61 return value>
      sample_c_lz r6.w, r12.zwzz, t0.xxxx, s0, r2.z  // r6.w <- <SampleTextureAndCompare_id61 return value>
...
#line 449
      sample_c_lz r5.w, r15.xyxx, t0.xxxx, s0, r2.z  // r5.w <- <SampleTextureAndCompare_id61 return value>

#line 508
      mad r2.x, r9.x, r5.w, r2.x

#line 449
      sample_c_lz r5.w, r14.xyxx, t0.xxxx, s0, r2.z

#line 508
      mad r2.x, r13.y, r5.w, r2.x

#line 449
      sample_c_lz r5.w, r14.zwzz, t0.xxxx, s0, r2.z

#line 508
      mad r2.x, r5.w, l(49.000000), r2.x

#line 449
      sample_c_lz r5.w, r15.zwzz, t0.xxxx, s0, r2.z

#line 508
      mad r2.x, r11.z, r5.w, r2.x

#line 449
      sample_c_lz r5.w, r10.xyxx, t0.xxxx, s0, r2.z

#line 508
      mad r2.x, r9.y, r5.w, r2.x

#line 449
      sample_c_lz r5.w, r10.zwzz, t0.xxxx, s0, r2.z

#line 508
      mad r2.x, r11.w, r5.w, r2.x

#line 449
      sample_c_lz r2.z, r7.xzxx, t0.xxxx, s0, r2.z  // r2.z <- <SampleTextureAndCompare_id61 return value>
...
#line 652
mov r2.w, l(0)
ld r0.xyzw, r2.xyzw, t1.xyzw  // r0.x <- streams.lightData_id171.x; r0.y <- streams.lightData_id171.y
...
#line 608
  ld r6.xyzw, r1.wwww, t2.xyzw  // r6.x <- realLightIndex
...
#line 611
  ishl r3.w, r6.x, l(2)
  ld r6.xyzw, r3.wwww, t4.xyzw  // r6.x <- spotLight1.x; r6.y <- spotLight1.y; r6.z <- spotLight1.z

#line 614
  iadd r7.yzw, r3.wwww, l(0, 1, 2, 3)
